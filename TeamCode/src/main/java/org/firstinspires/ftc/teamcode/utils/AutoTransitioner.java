 ...
 *      AutoTransitioner.transitionOnStop(this, "Prometheus Teleop");
 * Where 'Prometheus Teleop' is replaced with the NAME of your teleop program. See full documentation
